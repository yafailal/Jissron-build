  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-green-200 p-6">
        <h2 className="text-[13px] font-700 uppercase tracking-[.08em] text-muted mb-2">{t("confirmPaymentTitle")}</h2>
      ...
      <div className="bg-white rounded-2xl border border-red-100 p-6">
        <h2 className="text-[13px] font-700 uppercase tracking-[.08em] text-muted mb-2">{t("cancelOrderTitle")}</h2>
        <p className="text-[13px] text-muted font-500 mb-4 leading-relaxed">
          {t("cancelOrderDesc")}
        </p>
        ...
        {!showCancelConfirm ? (
          ...
          <div className="flex items-center gap-3">
            <span className="text-[13px] font-600 text-red-600">{t("areYouSure")}</span>
            <button
