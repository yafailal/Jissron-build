    ...
    if (process.env.RESEND_API_KEY) {
      try {
        ...
        await client.emails.send({
          from,
          to: user.email,
          subject: "Your AILearn session was reset by an admin",
          html: `<p>Hi ${user.name ?? "there"},</p>
                 <p>An administrator has signed you out of all devices on AILearn. To regain access, sign in again at <a href="${process.env.NEXTAUTH_URL ?? "https://ailearn.com"}/signin">ailearn.com/signin</a>.</p>
