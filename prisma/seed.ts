...
async function main() {
  ...
  await db.siteSettings.upsert({
    ...
    create: {
      ...
      colorPrimary: "#064e3b",
      colorPrimaryHover: "#0b6b53",
      colorPrimaryBright: "#10b981",
      colorInk: "#064e3b",
  ...
  const consultantData = [
    ...
    },
    {
      ...
      avatarGradient: "linear-gradient(135deg, #033a2c, #10b981)",
      totalSessions: 156,
      avgRating: 4.9,
      isFeatured: true,
      acceptsNew: true,
    ...
    },
    {
      ...
      avatarGradient: "linear-gradient(135deg, #064e3b, #d9dcd6)",
      totalSessions: 203,
      avgRating: 4.8,
      isFeatured: false,
      acceptsNew: true,
