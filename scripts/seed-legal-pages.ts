...
<h2>Who we are</h2>
<p>AILearn is an online learning platform offering courses, live sessions, and 1-on-1 consultations. This page explains what personal data we collect and how we use it.</p>
...
<p>By creating an account or making a purchase on AILearn, you agree to these terms. If you don't agree, please don't use the service.</p>
...
<ul>
  ...
  <li>Payment is processed by Stripe or CMI. AILearn receives only the transaction reference.</li>
...
<p>To the maximum extent permitted by law, AILearn's total liability for any claim arising from your use of the service is limited to the amount you paid us in the 12 months preceding the claim.</p>
  ...
  const pages = [
    {
      ...
      metaTitle: "Privacy Policy — AILearn",
      metaDescription:
        "How AILearn collects, uses, and protects your personal data.",
      published: true,
    },
    {
      slug: "terms",
      ...
      metaTitle: "Terms of Service — AILearn",
      metaDescription:
        "The rules and policies for using the AILearn learning platform.",
      published: true,
    },
  ];
